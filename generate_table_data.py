...
def find_country_code_column(country_name, countries_list):
...
outputfile = "country_city_population.csv"
...
for country in data:
    ...
    country_column = find_country_code_column(country_name, link)
    if country_column is None:
        continue
    for city in country["cities"]:
        city_name = city["link"]
        if "%" in city_name or city_name == "":
            continue
        ...
        out += str.format("{},{},{},{}\n",
                          i, city_name, country_column, population)
        i += 1
with open(outputfile, "w") as f:
    f.write(out)
